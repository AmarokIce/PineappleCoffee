...
/* MobEffect Util */
fun StatusEffect.instance(time: Int, amplifier: Int = 0): StatusEffectInstance = StatusEffectInstance(this, time, amplifier)
...
/* Other Util */
fun getItemByBlock(block: Block): Item? = Item.BLOCK_ITEMS[block]
